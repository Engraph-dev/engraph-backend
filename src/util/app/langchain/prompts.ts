...
const CYPHER_GENERATION_TEMPLATE = `Generate Cypher statement to query a graph database mapping a {projectType} project.
...
Always select the full source code of any module or file. 
Include the dependencies of a node in your query ONLY IF NECESSARY.
Include the dependents of a node in your query ONLY IF NECESSARY.
...
export const CYPHER_GENERATION_PROMPT = new PromptTemplate({
	...
	inputVariables: ["schema", "question", "projectType"],
})
